...
$SqlConnectionString = "Data Source=SQL2016;Initial Catalog=MySkySync;Integrated Security=False;User ID=SkySync;Password=Skyme1100" -f $SqlServer, $SqlDatabase;
$SqlQuery = @"
 SELECT ID, Name 
